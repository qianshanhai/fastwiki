...
public class Favorite extends SherlockActivity {  
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		customViewForDictView = (ViewGroup) getLayoutInflater().inflate(R.layout.favorite_bar, null);
		ab.setCustomView(customViewForDictView);

		m_list_color = WikiListColor();

		m_list_view = (ListView)findViewById(R.id.favorite_list);  
		m_text = (TextView)customViewForDictView.findViewById(R.id.favorite_bar_txt);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getSupportMenuInflater().inflate(R.menu.favorite_menu, menu);
